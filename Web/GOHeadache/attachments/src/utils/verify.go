...
var blacklist = map[string]string{
	...
	"172.":     "Blocked private IPv4 range",
...
var BadWords = []string{
	...
	"Users", "users", "getUsers", "manageUsers", "hermaphrodite", "bestiality", "zoophilia", "pedophile", "molester", "child porn", "rape", "kill", "die", "suicide", "terrorist", "bomb", "weapon", "gun", "knife", "knife fight", "gore", "murder", "massacre", "shooting", "behead", "execution", "butcher", "slaughter", "torture",
}
